public class PersonRegular {
    ...
    public static void main(String[] args){
        ...
        int firstPersonCar = 2010;
        int secondPersonCar = 2020;
        ...
        double adjustedRate3;
        double adjustedRate4;
        ...
        //logic in the car insurance industry - if you have poor credit, traffic tickets, DUIs, other violations,
...
// will gender and age make a difference?
        ...
        total1 = monthlyRate1 + adjustedRate1 + adjustedRate3;
        total2 = monthlyRate2 + adjustedRate2 + adjustedRate4;
